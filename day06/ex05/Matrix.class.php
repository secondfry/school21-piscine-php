...
class Matrix {
  ...
  public function transformTriangle(Triangle $triangle): Triangle {
    return new Triangle(
      $this->transformVertex($triangle->getA()),
      $this->transformVertex($triangle->getB()),
      $this->transformVertex($triangle->getC()),
    );
  }

  public function transformMesh(array $triangles): array {
    $ret = [];
    foreach ($triangles as $triangle) {
      $ret[] = $this->transformTriangle($triangle);
    }
    return $ret;
  }
